...
export default function MetricCard({ titulo, valor, color = 'blue', descripcion, subtitulo, cargando = false, animacion = false }: MetricCardProps) {
    const colores = {
    ...
    return (
        <div className={`p-6 rounded-lg border-2 ${colores[color as keyof typeof colores]} transition-all duration-300 hover:scale-105 ${cargando || animacion ? 'animate-pulse' : ''}`}>
