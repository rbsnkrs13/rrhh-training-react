...
import FiltroAvanzado from '@/Components/Empleados/FiltrosAvanzados';
                            ...
                            {empleadosFiltrados.length === 0 ? (
                                ...
                                <div className="grid gap-4">
                                    {empleadosFiltrados.map(empleado => (
                                        <div
                                            key={empleado.id}
                                            className="border border-gray-200 rounded-lg hover:border-blue-300 transition-all duration-200"
                                        >
